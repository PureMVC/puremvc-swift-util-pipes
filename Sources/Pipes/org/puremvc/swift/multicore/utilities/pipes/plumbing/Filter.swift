...
public class Filter: Pipe {
    ...
    private var _filter: ((_ message: IPipeMessage, _ params: Any?) -> Bool)? = { (IPipeMessage, Any) -> Bool in return true }
    ...
    */
    public override func write(_ message: IPipeMessage) -> Bool {
        var success = true
    ...
    func isTarget(_ message: IPipeMessage) -> Bool {
        return (message as! FilterControlMessage).name == self.name
    }

    /// Filter the message.
    func applyFilter(_ message: IPipeMessage) -> Bool {
    ...
    */
    public var filter: ((_ message: IPipeMessage, _ params: Any?) -> Bool)?  {
        get { return _filter }
