...
public class JunctionMediator: Mediator {
    ...
    public override func handleNotification(_ notification: INotification) {
        ...
        case JunctionMediator.ACCEPT_INPUT_PIPE:
            ...
            if junction.registerPipe(inputPipeName, type: Junction.INPUT, pipe: inputPipe) { //weak reference to JunctionMediator (self) to avoid reference cycle with Junction, context is defined as weak too
                _ = junction.addPipeListener(inputPipeName, context: self, listener: {[weak self] message in self!.handlePipeMessage(message)})
            }
        ...
        case JunctionMediator.ACCEPT_OUTPUT_PIPE:
            ...
            _ = junction.registerPipe(outputPipeName, type: Junction.OUTPUT, pipe: outputPipe)
    ...
    */
    public func handlePipeMessage(_ message: IPipeMessage) {
