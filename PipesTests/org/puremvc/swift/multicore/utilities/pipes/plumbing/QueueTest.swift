...
class QueueTest: XCTestCase {
    ...
    */
    func testWritingMultipleMessagesAndFlush() {
        ...
        let received1 = messagesReceived.removeAtIndex(0)
        ...
        let received2 = messagesReceived.removeAtIndex(0)
        ...
        let received3 = messagesReceived.removeAtIndex(0)
    ...
    */
    func testSortByPriorityAndFIFO() {
        ...
        // get the messages
        let received1Again = messagesReceived.removeAtIndex(0)
        let received2Again = messagesReceived.removeAtIndex(0)
        let received3Again = messagesReceived.removeAtIndex(0)
